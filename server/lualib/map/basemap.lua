...
local function init_method(map)
    ...
    -- 创建一个临时id
    function map:createtempid() return idmgr:createid() end
    ...
    -- 加载地图信息
    function map:loadmapinfo() end

    -- 获取地图id
    function map:getmapid() return self.id end

    -- 获取副本id
    function map:getdungonid() return self.dungeon_id end

    -- 获取副本实例id
    function map:getdungoninstanceid() return self.dungeon_instance_id end
